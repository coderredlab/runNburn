...
fn main() {
    ...
    // Step 2: open target file with O_DIRECT
    let path = std::env::var("RNB_IOURING_PATH")
        .unwrap_or_else(|_| "/data/local/tmp/rnb/gemma-4-26B-A4B-it-Q4_K_M.cold.rnb".to_string());
