...
use super::super::vulkan_backend::{
    ...
    gdn_ssm_out_id as backend_gdn_ssm_out_id,
    ggml_to_fullpath_quant as backend_ggml_to_fullpath_quant, ggml_to_output_quant,
...
pub fn ggml_to_fullpath_quant(ggml_type: GGMLType) -> Option<Quant> {
    backend_ggml_to_fullpath_quant(ggml_type)
}
