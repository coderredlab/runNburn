...
pub use glm_moe::{
    ...
    glm_moe_direct_file_prefill_enabled, glm_moe_prefill_sparse_experts_iq2xxs_iq3xxs_by_token,
};
pub use output::{
...
pub use prefill::{
    decode_gemv_into_if_supported, prefill_gemv, prefill_gemv_enabled,
    prefill_q4k_f16_gemm_allowed,
...
pub use qwen_moe::{
    ...
    qwen35_mtp_device_verify_window, qwen_moe_decode_down, qwen_moe_decode_expert,
    ...
    qwen_moe_prepare_selected_bundle_residency, qwen_moe_register_layer,
...
pub use rnb_backend_api::{DeviceTensorDesc, DeviceTensorId, DeviceTensorRole, ScalarType};
...
pub fn prewarm_q4k_sidecar_packed_weights(
    ...
    backend::prewarm_q4k_sidecar_packed_weights(weights)
}
...
pub fn prewarm_q6k_sidecar_packed_weights(
    ...
    backend::prewarm_q6k_sidecar_packed_weights(weights)
}
