...
pub use qwen_moe::{
    ...
    qwen35_prefill_attention_device_input, qwen_moe_configure_layer_cache,
    qwen_moe_decode_admit_expert_misses_async, qwen_moe_decode_down, qwen_moe_decode_expert,
    ...
    qwen_moe_decode_sparse_experts_resident_partial_into,
