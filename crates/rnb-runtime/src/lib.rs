...
pub mod compute {
    ...
    pub use rnb_backend_cuda::{
        ...
        dense_q4k_silu_ffn_batch, f16_gemv, f16_gemv_batch, f32_gemm_batch, f32_shared_expert,
        free_delta_state_snapshot, gdn_gated_norm_silu, gdn_gated_norm_silu_f32_gemm,
        gdn_prefill_chain_q4k, gdn_prefill_chunk_unimplemented_for_test, gemma4_moe_gelu_selected,
