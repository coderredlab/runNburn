...
pub mod compute {
    ...
    pub use rnb_backend_cuda::{
        ...
        attention_prefill_flash_hd128, attention_prefill_flash_hd256,
        ...
        dense_q4k_gelu_ffn, dense_q4k_gelu_ffn_batch, dense_q4k_gelu_ffn_batch_fused_gate_up,
        dense_q4k_gelu_ffn_norm_residual, dense_q4k_silu_ffn_batch, f16_gemv, f16_gemv_batch,
        f32_gemm_batch, f32_shared_expert, free_delta_state_snapshot, gdn_gated_norm_silu,
        gdn_gated_norm_silu_f32_gemm, gdn_prefill_chain_q4k,
        gdn_prefill_chunk_unimplemented_for_test, gemma4_ple_q4k_batch_norm_residual,
        gemma4_selected_moe_admitted, glm_mla_prefill_attention_f16, glm_shared_expert_iq,
        glm_sparse_experts_iq2xxs_iq3xxs, glm_sparse_experts_iq_by_token, iq2_s_gemv,
        iq2_s_gemv_batch, iq2_xxs_gemv, iq2_xxs_gemv_batch, iq3_xxs_gemv, iq3_xxs_gemv_batch,
        iq4_xs_gemv, iq4_xs_gemv_batch, nemotron_device_route_pack_expert_ids,
        ...
        release_q8_0_prefill_f32_after_prefill, reset_delta_state_cache, restore_delta_state_cache,
        snapshot_delta_state_cache, ssm_conv1d_silu, sync_delta_state_cache, upload_gemma_ple_base,
        CudaMemoryInfo, DeltaStateSnapshot, GdnPrefillChainPlan, GdnPrefillChainQ4KOutput,
