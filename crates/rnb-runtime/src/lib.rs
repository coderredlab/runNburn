...
pub mod compute {
    ...
    pub use rnb_backend_cuda::{
        ...
        prewarm_quant_resident_q4k_weights, q2k_gemv, q2k_gemv_batch, q3k_gemv, q3k_gemv_batch,
        ...
        q4k_muse_prefill_hd128_dense_chain, q5_0_gemv, q5_0_gemv_batch, q5_1_gemv, q5_1_gemv_batch,
        q5k_gemv, q5k_gemv_batch, q6k_gemv, q6k_gemv_argmax, q6k_gemv_batch, q6k_gemv_into,
        q6k_gemv_into_touch_hit, q8_0_f32_gemm_batch_cached, q8_0_gemv, q8_0_gemv_argmax,
        q8_0_gemv_argmax_q8dot, q8_0_gemv_batch, q8_0_head_gemv_batch, q8_1_gemv, q8_1_gemv_batch,
        quant_embedding_gather, qwen35_admit_expert_misses_async, qwen35_configure_moe_layer_cache,
