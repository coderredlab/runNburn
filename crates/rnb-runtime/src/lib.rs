...
pub mod compute {
    ...
    pub use rnb_backend_cuda::{
        ...
        attention_prefill_flash_hd512_f16kv_window_dense_chain, bf16_gemv, bf16_gemv_batch,
        ...
        release_nemotron_device_route_pack, release_prefill_compute_buffers,
        release_q4_f32_after_prefill, release_q8_0_prefill_f32_after_prefill,
        reset_delta_state_cache, reset_state_for_engine_init, restore_delta_state_cache,
        snapshot_delta_state_cache, sparse_experts_by_token_clamped_swiglu_resident,
