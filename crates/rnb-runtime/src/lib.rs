...
pub mod compute {
    ...
    pub use rnb_backend_api::{
        KvarnDecodeRequest, PersistentDecodeLayerInput, PersistentDecodeRequest,
        PERSISTENT_DECODE_FLAG_ATTN_ROT, PERSISTENT_DECODE_FLAG_DOWN_Q6K,
        PERSISTENT_DECODE_FLAG_GATED_ATTN, PERSISTENT_DECODE_FLAG_K_Q6K,
        PERSISTENT_DECODE_FLAG_O_Q6K, PERSISTENT_DECODE_FLAG_PLE_F32,
    ...
    pub use rnb_backend_cuda::{
        ...
        acquire_decode_v_f16_carrier, activation_mul_f32_inplace, add_f32_inplace,
        add_rows_f32_inplace, axpby_f32_inplace, dense_q4k_attention_qkv_with_device_input,
        download_from_decode_hidden_carrier, f32_to_f16_pack_device,
        gdn_prepare_delta_gate_beta_f32, hadamard_f32_inplace, l2_norm_rows_f32,
        moe_route_topk_f32, mul_rows_f32_inplace, q4k_gemv_with_device_input,
        q6k_gemv_with_device_input, relu_sqr_f32_inplace, rms_norm_f32_dev_input_to_carrier,
        rms_norm_f32_to_carrier, rms_norm_rows_f32, rope_f32_inplace, scale_f32_inplace,
        sigmoid_f32_inplace, sigmoid_mul_f32_inplace, sync_decode_stream,
        upload_to_decode_hidden_carrier,
    };
    ...
    pub use rnb_backend_cuda::{
        ...
        attention_decode_hd512_len_device, attention_decode_kvarn,
        attention_decode_kvarn_to_device, attention_prefill_flash_f32,
        attention_prefill_flash_f32_non_causal, attention_prefill_flash_hd128,
        ...
        begin_muse_decode_residency_lifecycle, bf16_gemv, bf16_gemv_batch,
        clear_decode_attention_kv_cache, clear_host_registered_ranges,
        clear_moe_expert_slice_cache, clear_moe_layer_cache, clear_q4_f32_cache, clear_q4k_cache,
        clear_sequence_state_cache, cuda_memory_info, deepseek4_q8_output_projection,
        ...
        dense_q4k_silu_ffn_batch, dense_q4k_silu_ffn_batch_device_carrier, dflash_q4k_layer_chain,
        f16_gemv, f16_gemv_batch, f32_gemm_batch, f32_shared_expert, free_delta_state_snapshot,
        gdn_gated_norm_silu, gdn_gated_norm_silu_f32_gemm, gdn_prefill_chain_q4k,
        gdn_prefill_chunk_unimplemented_for_test, gemma4_moe_gelu_selected,
        ...
        glm_sparse_experts_iq_by_token, iq2_s_gemv, iq2_s_gemv_batch, iq2_xxs_gemv,
        iq2_xxs_gemv_batch, iq3_xxs_gemv, iq3_xxs_gemv_batch, iq4_xs_gemv, iq4_xs_gemv_batch,
        muse_decode_tail_reserve_bytes, mxfp4_sparse_experts_by_token_clamped_swiglu,
        ...
        prewarm_q4k_prefill_f16_weights, prewarm_q4k_weights, prewarm_q4k_weights_pinned,
        prewarm_q4k_weights_pinned_complete_groups, prewarm_q4k_weights_pinned_prefix,
        prewarm_q6k_f32_weights, prewarm_q6k_packed_weights, prewarm_q8_0_weight,
        prewarm_quant_resident_weights, q2k_gemv, q2k_gemv_batch, q3k_gemv, q3k_gemv_batch,
        q4_0_gemv, q4_0_gemv_batch, q4_1_gemv, q4_1_gemv_batch, q4k_f16_gemm_batch,
        ...
        q4k_gemv, q4k_gemv_batch, q4k_gemv_into, q4k_gemv_into_touch_hit,
        q4k_muse_prefill_hd128_dense_chain, q4k_muse_prefill_hd128_dense_chain_device_input,
        q5_0_gemv, q5_0_gemv_batch, q5_1_gemv, q5_1_gemv_batch, q5k_gemv, q5k_gemv_batch, q6k_gemv,
        ...
        qwen35_gdn_decode_core_chain_admitted, qwen35_mtp_device_draft_step,
        ...
        qwen35_sparse_experts_resident_partial_into, qwen35_sparse_experts_selected_base_by_token,
        release_muse_decode_tail_residency, release_nemotron_device_route_pack,
        release_prefill_compute_buffers, release_q4_f32_after_prefill,
        release_q8_0_prefill_f32_after_prefill, reset_delta_state_cache,
        reset_state_for_engine_init, restore_delta_state_cache, snapshot_delta_state_cache,
        sparse_experts_by_token_clamped_swiglu_resident,
        sparse_experts_iq2xxs_iq3xxs_by_token_clamped_swiglu, ssm_conv1d_silu,
        sync_delta_state_cache, upload_gemma_ple_base, with_dflash_exact_verify, CudaMemoryInfo,
        ...
        MuseQ4kPrefillDeviceOutput, NemotronDeviceRoutePack as BackendNemotronDeviceRoutePack,
        Qwen35MtpDeviceDraftRequest, Qwen35MtpDeviceDraftResult,
        ...
        Qwen35MtpDeviceVerifySsmLayerPrefixState, QwenGdnDecodeChainArgs,
    };
    pub use rnb_backend_cuda::{
        ...
        device_kv_cache_f16_matches, launch_attention_decode_device,
        launch_attention_decode_device_len_device, plan_gdn_prefill_chain,
    ...
    pub mod tuning {
        pub use rnb_backend_cuda::tuning::{
            ...
            gdn_prefill_chain_dense_ffn_device_enabled, gdn_prefill_chain_device_output_enabled,
            gdn_prefill_chain_enabled, gdn_prefill_chain_moe_input_device_enabled,
...
pub(crate) mod vulkan_backend {
    pub use rnb_backend_vulkan::{
        ...
        ggml_to_fullpath_quant, ggml_to_output_quant, ggml_to_quant, init_layer_gemv,
        init_layer_gemv_for_test, initial_fullpath_staging_tokens, k_proj_id, max_decode_layer,
        o_proj_id, output_logits_enabled, output_logits_id, prefill_chunk_size_for_active_path,
        q_proj_id, v_proj_id, verify_attention_layer, verify_attention_qkv_layer, verify_gdn_layer,
        QuantType, WeightId,
    };
...
pub mod scheduler {
    ...
    pub use rnb_scheduler::{
        force_mobile_vulkan_requested, fullpath_gpu_prefill_requested, plan_gpu_layer_prefix,
        plan_moe_jit_load_order, plan_slice1_boundary, select_prefill_path,
        select_prefill_path_for_profile, select_runtime_execution_profile,
        should_attempt_slice1_gpu_prefill, ExecutionProfileRequest, PrefillExecutionPath,
        RuntimeExecutionProfile, Slice1BoundaryPlan,
    };
}
...
pub use rnb_backend_api::{
    ...
    DeviceTensorDesc, DeviceTensorId, DeviceTensorRole, DeviceTransferCounters, KvarnChainView,
};
