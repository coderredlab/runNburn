...
#[cfg(test)]
pub fn q4k_sidecar_packed_q8_for_test(
    source_weights: &[u8],
    sidecar_packed: &[u8],
    rows: usize,
    cols: usize,
    ...
    q4k_packed_q8_with_resident_weight_for_test(rows, cols, input, |state, blocks_per_row| {
        state.resident_q4k_sidecar_packed_ptr(source_weights, sidecar_packed, rows, blocks_per_row)
    })
}
...
#[cfg(test)]
pub fn q6k_sidecar_packed_q8_for_test(
    source_weights: &[u8],
    sidecar_packed: &[u8],
    rows: usize,
    cols: usize,
    ...
    q6k_packed_q8_with_resident_weight_for_test(rows, cols, input, |state, blocks_per_row| {
        state.resident_q6k_sidecar_packed_ptrs(source_weights, sidecar_packed, rows, blocks_per_row)
    })
}
