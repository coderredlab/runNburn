...
pub(super) struct CudaState {
    ...
    pub(super) configured_device_residency_plan: rnb_memory::DeviceResidencyPlan,
    pub(super) configured_resident_q4k_limit: usize,
    pub(super) muse_decode_tail_pinned_keys: Vec<(usize, usize)>,
    pub(super) muse_decode_tail_uploaded_keys: Vec<(usize, usize)>,
    pub(super) muse_decode_tail_streaming: bool,
    pub(super) muse_decode_tail_base_residency: Option<(rnb_memory::DeviceResidencyPlan, usize)>,
    ...
    pub(super) prefill_scratch_saved_moe_limit: Option<usize>,
