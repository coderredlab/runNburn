...
impl CudaState {
    ...
    pub(in crate::runtime) fn open_ordinal(ordinal: i32) -> Result<Self, String> {
        ...
        Ok(Self {
            ...
            configured_device_residency_plan: device_residency_plan,
            configured_resident_q4k_limit: resident_q4k_limit,
            muse_decode_tail_pinned_keys: Vec::new(),
            muse_decode_tail_uploaded_keys: Vec::new(),
            muse_decode_tail_streaming: false,
            muse_decode_tail_base_residency: None,
            cublas: None,
