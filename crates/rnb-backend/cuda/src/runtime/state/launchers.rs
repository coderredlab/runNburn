...
impl CudaState {
    ...
    #[allow(clippy::too_many_arguments)]
    pub(in crate::runtime) fn launch_selected_iq2_xxs_gate_up_gemv_by_token_to_dev(
        &mut self,
        gate_ptrs_dev: u64,
        up_ptrs_dev: u64,
        token_ids_dev: u64,
    ...
    #[allow(clippy::too_many_arguments)]
    pub(in crate::runtime) fn launch_selected_iq2_xxs_gate_up_gemv_by_token_group4(
        &mut self,
        gate_ptrs_dev: u64,
        up_ptrs_dev: u64,
        token_ids_dev: u64,
        ...
        let mut blocks_per_row_arg = blocks_per_row as u32;
        self.launch_cached_gemv(
            "rnb_iq2_xxs_selected_gate_up_gemv_by_token_group4_warp4",
            &[
                (&mut gate_out_arg as *mut u64).cast::<libc::c_void>(),
                (&mut up_out_arg as *mut u64).cast::<libc::c_void>(),
                (&mut gate_weights_arg as *mut u64).cast::<libc::c_void>(),
    ...
    #[allow(clippy::too_many_arguments)]
    pub(in crate::runtime) fn launch_selected_iq3_xxs_down_accum_by_token_group4(
        &mut self,
        down_ptrs_dev: u64,
        token_ids_dev: u64,
        group_meta_dev: u64,
        ...
        let mut blocks_per_row_arg = blocks_per_row as u32;
        self.launch_cached_gemv(
            "rnb_iq3_xxs_selected_down_accum_by_token_group4_warp4",
            &[
                (&mut output_arg as *mut u64).cast::<libc::c_void>(),
    ...
    pub(in crate::runtime) fn launch_cached_gemv(
        ...
        if self.q4k_gemv_module.is_none() {
            let module = unsafe { self.api.module_load_data(Q4K_GEMV_PARALLEL_PTX)? };
    ...
    pub(in crate::runtime) fn launch_cached_nemotron_selected(
        ...
        if self.nemotron_selected_module.is_none() {
            let module = unsafe { self.api.module_load_data(NEMOTRON_SELECTED_PTX)? };
