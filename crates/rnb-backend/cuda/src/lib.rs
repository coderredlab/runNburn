...
pub use runtime::{
    ...
    dense_q4k_gelu_ffn_norm_residual, dense_q4k_silu_ffn_batch, derive_gdn_prefill_chain_dims,
    end_nemotron_prefill_workspace, f16_gemv, f16_gemv_batch, f32_gemm_batch, f32_shared_expert,
    ...
    restore_delta_state_cache, rope_f32_inplace, scale_f32_inplace, sigmoid_f32_inplace,
    sigmoid_mul_f32_inplace, snapshot_delta_state_cache, ssm_conv1d_silu, sync_delta_state_cache,
