...
pub use runtime::{
    ...
    begin_muse_decode_residency_lifecycle, begin_nemotron_prefill_workspace, bf16_gemv,
    bf16_gemv_batch, build_gdn_prefill_chain_conv_input_for_test, clear_decode_attention_kv_cache,
    clear_host_registered_ranges, clear_moe_expert_slice_cache, clear_moe_layer_cache,
    clear_q4_f32_cache, clear_q4k_cache, clear_sequence_state_cache, cuda_memory_info,
    deepseek4_q8_output_projection, delta_net_decode, delta_net_decode_resident, delta_net_prefill,
    delta_net_prefill_resident, delta_net_prefill_resident_snapshot,
    ...
    prewarm_q4k_weights_pinned, prewarm_q4k_weights_pinned_complete_groups,
    ...
    q4k_muse_prefill_hd128_dense_chain, q4k_muse_prefill_hd128_dense_chain_device_input, q5_0_gemv,
    q5_0_gemv_batch, q5_1_gemv, q5_1_gemv_batch, q5k_gemv, q5k_gemv_batch, q5k_gemv_into, q6k_gemv,
    ...
    release_q8_0_prefill_f32_after_prefill, relu_sqr_f32_inplace, reset_delta_state_cache,
    reset_state_for_engine_init, restore_delta_state_cache, rope_f32_inplace, scale_f32_inplace,
    sigmoid_f32_inplace, sigmoid_mul_f32_inplace, snapshot_delta_state_cache,
    ...
    MuseQ4kPrefillDeviceOutput, NemotronDeviceRoutePack, NemotronDeviceRouterLogitsOutput,
    NemotronMamba2DeviceOutput, NemotronPrefillWorkspaceConfig, NemotronPrefillWorkspaceSummary,
