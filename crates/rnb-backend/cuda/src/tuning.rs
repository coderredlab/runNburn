...
pub fn mtp_verify_resident_moe_layer_enabled() -> bool {
    env_bool("RNB_CUDA_MTP_VERIFY_RESIDENT_MOE_LAYER", false)
}
...
pub fn gdn_prefill_chain_enabled() -> bool {
    env_bool("RNB_CUDA_GDN_PREFILL_CHAIN", false)
}
...
pub fn gdn_prefill_chain_moe_input_device_enabled() -> bool {
    env_bool("RNB_CUDA_GDN_PREFILL_CHAIN_MOE_INPUT_DEVICE", false)
}

pub fn gdn_prefill_chain_moe_output_device_enabled() -> bool {
    env_bool("RNB_CUDA_GDN_PREFILL_CHAIN_MOE_OUTPUT_DEVICE", false)
}

pub fn gdn_prefill_chain_skip_host_projection_enabled() -> bool {
    env_bool("RNB_CUDA_GDN_PREFILL_CHAIN_SKIP_HOST_PROJECTION", false)
}
