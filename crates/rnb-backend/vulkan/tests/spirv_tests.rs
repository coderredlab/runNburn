use rnb_backend_vulkan::spirv::{
    emit_attention_decode, emit_elem_add, emit_elem_add_out, emit_f32_gemv, emit_gdn_delta_step,
    emit_gdn_gated_norm_silu, emit_q4k_block_reduce, emit_q4k_gemv, emit_q4k_gemv_block_partial,
    emit_q4k_gemv_wg_reduce, emit_q4k_q8k_gemv, emit_q5k_gemv, emit_q6k_gemv, emit_q6k_q8k_gemv,
    emit_q8_0_gemv, emit_quantize_to_q8k, emit_rms_norm, emit_rope_apply, emit_silu_mul,
    SpirvModule,
};
