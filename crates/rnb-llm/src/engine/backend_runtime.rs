...
pub(super) use cuda_basic::{
    ...
    metal_deepseek4_q_front_if_supported, metal_prefill_atn_full_counters_report,
    ...
    metal_prefill_attn_chain_if_supported, metal_prefill_delta_net_scan_into_if_supported,
    metal_prefill_gdn_f32_dual_proj_if_supported, metal_prefill_gdn_proj_into_if_supported,
...
pub(super) use cuda_basic::{
    ...
    gemma4_moe_gelu_selected_if_supported, nemotron_device_route_pack_expert_ids,
    nemotron_device_route_pack_from_logits, nemotron_mamba2_prefill_device,
    nemotron_q8_shared_q5_sparse_prefill_moe_device_ids,
