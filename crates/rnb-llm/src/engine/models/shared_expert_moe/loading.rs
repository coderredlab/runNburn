...
pub(in crate::engine) fn load_shared_expert_moe_layer(
    ...
    Some(SharedExpertMoELayerWeights {
        ...
        // Session 73 — wiring loops populate later
        packed_model: None,
        ...
        // Session 79 Phase 1 Task 12: populated post-hoc by the
        // MoE section `.rnb` MOE_DECODE_SECTION detection loop in
        // `Engine::from_gguf` (see below).
        moe_section_decode: None,
        // Filled later when a v3 sidecar carries MoE hot/cold tier metadata.
        gate_residency: None,
        up_residency: None,
        down_residency: None,
    })
