...
pub fn select_prefill_path_for_profile(
    ...
    if !should_attempt_slice1_gpu_prefill(token_count, has_slice1_plan)
    ...
    match profile {
        ...
        | RuntimeExecutionProfile::CudaGpuResident => PrefillExecutionPath::Slice1GpuCandidate,
    }
}
...
mod tests {
    ...
    fn plans_slice1_prefill_boundary_from_layer_counts() {
        ...
        // Fullpath requested but no slice1 plan / no active GPU path -> Cpu.
        assert_eq!(
